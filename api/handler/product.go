...
func (h *Handler) CreateProduct(c *gin.Context) {
	...
	id, err := h.storage.Product().Insert(context.Background(), &product)
	if err != nil {
		log.Println("error whiling create product :", err.Error())
...
// @Produce json
// @Param id path string true "id"
// @Param product body models.UpdateProductSwag true "UpdateProductRequestBody"
...
func (h *Handler) UpdateProduct(c *gin.Context) {
	...
	resp, err := h.storage.Product().GetByID(context.Background(), &models.ProductPrimeryKey{Id: id})
	if err != nil {
...
func (h *Handler) DeleteProduct(c *gin.Context) {
	...
	if err != nil {
		log.Println("error whiling deleting product:", err.Error())
		c.JSON(http.StatusNoContent, err.Error())
		return
	}
	c.JSON(http.StatusAccepted, "product deleted")
}
